...
module.exports = plugin(function ({ addComponents }) {
    addComponents({
        ...
        '.detached': {
            '.sidebar': {
                '@apply overflow-hidden border rounded-md border-t-white border-black/10 inset-y-4 dark:border-darkborder': {},
            ...
            '&.detached-simple': {
                ...
                '.detached-topbar': {
                    '@apply border border-black/10 dark:border-darkborder': {},
                },
                '.sidebar': {
